var AppInbox = function () {
    ...
    var loadInbox = function (el, name, filter, start) {
        var url;
        ...
        $.ajax({
            ...
            url: url,
            dataType: "json",
            data: {filter: filter, start: start,},
            ...
            success: function(res) 
            {
                ...
                record_start =  parseInt(start_page) + 1;
    ...
    return {
        ...
        init: function () {
            ...
            $('.inbox').on('click', '.pagination-control > a', function(event) {
                ...
                /*if (start_page != $('#filter').val() && start_page != 0) {
                    start_page = $('#filter').val();
                }*/
