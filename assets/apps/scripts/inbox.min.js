var AppInbox = function () {
    ...
    var loadInbox = function (el, name, filter) {
        var url;
    ...
    function update_message_counter(){
                 ...
                 $.ajax({
                            ...
                            {   
                                ...
                                switch(navi){
                                    case 'Inbox':
                                         var display_list = (res.inbox_all > 0) ? '1 - ' + $('#filter').val() + ' of ' + res.inbox_all : '';
                                         $('.pagination-info').html(display_list);
                                    break;

                                    case 'Important':
                                         var display_list = (res.important > 0) ? '1 - ' + $('#filter').val() + ' of ' + res.important : '';
                                         $('.pagination-info').html(display_list);
                                    break;

                                    case 'Spam':
                                         var display_list = (res.spam > 0) ? '1 - ' + $('#filter').val() + ' of ' + res.spam : '';
                                         $('.pagination-info').html(display_list);
                                    break;

                                    case 'Trash':
                                         var display_list = (res.trash > 0) ? '1 - ' + $('#filter').val() + ' of ' + res.trash : '';
                                         $('.pagination-info').html(display_list);
                                    break;
                                }
        ...
        init: function () {
            ...
            $('.inbox').on('change', '#filter', function(event) {
                ...
                //alert($(this).val());
                  ...
                  $('.inbox-nav > li.active >a').each(function(index, el) {
                       loadInbox($(this), listListing, $(that).val());
                  });
            ...
            $('.inbox').on('click', '.list-actions > li > a', function (e) {
                ...
                .done(function(response) {
                    ...
                    $('.inbox-nav > li.active >a').each(function(index, el) {
                       loadInbox($(this), listListing, $('#filter').val());
                    });
