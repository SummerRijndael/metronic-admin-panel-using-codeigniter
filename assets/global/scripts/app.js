   ...
   var handleHeight = function() {
    ...
    return {
        ...
        init: function() {
            ...
            $(".checkbox-fullsize").labelauty({ minimum_width: "100%" });
            $(".checkbox-halfsize").labelauty({ minimum_width: "50%" });
...
$('[data-toggle="mainmodal"]').bind('click',function(e) {
  ...
  if (url.indexOf('#') === 0) {
    ...
    }).success(function() { Pace.stop();  });
  }
}); 
}
modalfunc();

function notifyU(state, message, title){
      toastr.options = {
                  "closeButton": true,
                  "debug": false,
